  ...
  return (
    <div className="flex items-center justify-center flex-col ">
      <div className="max-w-[640px]">
        ...
        <div className="flex items-center gap-4 mb-11 justify-center ">
          {tabs.map((tab) => (
            <button
              key={tab.key}
              className={`w-28 text-center py-[6px] font-normal text-base ${
                activeTab === tab.key
      ...
      <div className="flex flex-col items-center justify-center mt-12 ">
        ...
        <p className="mt-[50px] text-base text-[#000000] font-normal ">Artıq hesabınız var? <span className="text-[#0D9CD8] underline">Daxil olun</span></p>
      </div>
    </div>
  );
};
