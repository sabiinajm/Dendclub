  ...
  return (
    <div>
      <div
        ...
        className={`flex items-center gap-2 border px-4 py-[15px]  rounded-xl text-xs cursor-pointer mb-4 ${active.stepone && "border-[#0D9CD8] bg-[#E1F4FD]"
          } `}
      >
        {active.stepone ? (
          <svg
          ...
          >
            ...
            <g clipPath="url(#clip0_1770_7104)">
              <path
          ...
          >
            ...
            <g clipPath="url(#clip0_1770_7117)">
      ...
      <div
        ...
        className={`flex items-center gap-2 border px-4 py-[15px]  rounded-xl text-xs cursor-pointer ${active.steptwo && "border-[#0D9CD8] bg-[#E1F4FD]"
          } `}
      >
        {active.steptwo ? (
          <svg
