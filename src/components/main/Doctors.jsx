...
function Doctors() {
    ...
    return (
        <main className="bg-[#f2f5f8]  pt-[24px]">
            ...
            <h1 className="pt-[7rem] pb-[4rem] text-[#030303] text-2xl md:text-[40px] leading-[56px] text-center">Peşəkar Həkimlərimiz</h1>
            <div className="max-w-[1224px] w-[95%] mx-auto pt-[45px] pb-[56px]">
