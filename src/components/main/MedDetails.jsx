            ...
            <div className="max-w-[1224px] mx-auto px-2">
                    ...
                    <div className="flex gap-[14px]">
                        <div className="flex items-center w-[116px] h-[44px] bg-[#0D9CD8] rounded-[48px] text-white justify-center gap-[10px]">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <path d="M9.5489 20.7497C10.4883 20.7497 11.2499 19.9881 11.2499 19.0487C11.2499 18.1092 10.4883 17.3477 9.5489 17.3477C8.60946 17.3477 7.8479 18.1092 7.8479 19.0487C7.8479 19.9881 8.60946 20.7497 9.5489 20.7497Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M16.96 20.7497C17.8995 20.7497 18.661 19.9881 18.661 19.0487C18.661 18.1092 17.8995 17.3477 16.96 17.3477C16.0206 17.3477 15.259 18.1092 15.259 19.0487C15.259 19.9881 16.0206 20.7497 16.96 20.7497Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M5.606 5.555L7.616 11.919C7.925 12.897 8.079 13.386 8.376 13.748C8.636 14.068 8.975 14.315 9.358 14.468C9.793 14.641 10.305 14.641 11.331 14.641H15.186C16.212 14.641 16.724 14.641 17.158 14.468C17.542 14.315 17.88 14.068 18.141 13.748C18.437 13.386 18.591 12.897 18.901 11.919L19.31 10.623L19.55 9.857L19.881 8.807C19.9991 8.4325 20.0274 8.03544 19.9634 7.648C19.8995 7.26055 19.7452 6.89361 19.513 6.57691C19.2809 6.26021 18.9774 6.00266 18.6271 5.82511C18.2768 5.64757 17.8897 5.55503 17.497 5.555H5.606ZM5.606 5.555L5.595 5.518C5.55277 5.37656 5.50608 5.23649 5.455 5.098C5.25255 4.58554 4.90923 4.14082 4.46473 3.81523C4.02022 3.48963 3.49266 3.29645 2.943 3.258C2.84 3.25 2.727 3.25 2.5 3.25" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                            0 AZN
                        </div>
                ...
                <div className="relative pb-[49px]">
                    ...
                    <div className="absolute top-[18px] right-5">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <path d="M11 19C15.4183 19 19 15.4183 19 11C19 6.58172 15.4183 3 11 3C6.58172 3 3 6.58172 3 11C3 15.4183 6.58172 19 11 19Z" stroke="#2C2C2E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M21.0004 21.0004L16.6504 16.6504" stroke="#2C2C2E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                    </div>
                </div>
