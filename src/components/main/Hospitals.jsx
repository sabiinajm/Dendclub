    ...
    return (
        <main className="bg-[#f2f5f8] pt-[24px]">
            <div className="max-w-[1224px] mx-auto px-2">
                <h1 className="pt-[7rem] pb-[4rem] text-[#030303] text-2xl md:text-[40px] leading-[56px] text-center">Ən Müasir Klinikalarımız!</h1>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 pt-[65px] justify-center">
                    {Array.from({ length: 9 }).map((_, index) => (
                        <div key={index} className="min-h-[427px] relative bg-white shadow-lg rounded-[20px] overflow-hidden">
                            ...
                            <p className="text-start py-7 pl-3 text-[24px] md:text-[28px] font-medium text-[#2C2C2E]">Istanbul Klinika NS</p>
