    ...
    return (
        <main className="bg-[#f2f5f8] pt-[24px]">
            <div className="max-w-[1224px] mx-auto px-2">
                <h1 className="pt-[7rem] pb-[4rem] text-[#030303] text-2xl md:text-[2.5rem] leading-[56px] text-center">Ən Müasir Klinikalarımız!</h1>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-12 pt-[65px] justify-center">
                    {Array.from({ length: 9 }).map((_, index) => (
                        <Link to={`/Klinikalarımız/${index + 1}`} key={index} className="min-h-[427px] relative bg-white shadow-lg rounded-[20px] overflow-hidden">
