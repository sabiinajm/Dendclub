function Footer() {
    return (
            <div className="bg-[white] pt-[70px]">
                <div className="mx-auto max-w-[1224px] flex justify-between px-4 pb-[80px]">
                    <div className="w-[450px]">
                        <h2 className="text-[35px] font-medium text-[#2C2C2E] leading-[48px]">Bizimlə əməkdaşlıq üçün
                            müraciət et!</h2>
                        <button className="w-[156px] h-[48px] rounded-[8px] bg-[#0D9CD8] text-white mt-[48px]">Müraciət et</button>
                    </div>
                    <div className="flex flex-col justify-between">
                        <div>
                            <p className="text-[#636366] text-[20px] text-right">Bizi sosial şəbəkələrdən izləyin</p>
                        ...
                        <ul className="text-[#2C2C2E] text-[20px] flex gap-6">
                ...
                <div className="flex justify-center gap-3 text-[#2C2C2E] text-[14px] border-t py-[17px]">
