...
function Queues() {
    const { activeIndex } = useOutletContext();
    return (
        <>
            {activeIndex === 1 && (
                    ...
                    <ul className="flex">
                        <li className="text-black border-b border-black  inline-flex items-center gap-2 py-3 px-4 font-medium text-sm">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                <g clip-path="url(#clip0_682_17098)">
                                    <path d="M12.6665 5.80782L9.11119 3.04248C8.79918 2.79975 8.41516 2.66797 8.01986 2.66797C7.62455 2.66797 7.24053 2.79975 6.92852 3.04248L3.37252 5.80782C3.15882 5.974 2.98592 6.18683 2.86703 6.43005C2.74814 6.67326 2.6864 6.94043 2.68652 7.21115V12.0111C2.68652 12.3648 2.827 12.7039 3.07705 12.954C3.3271 13.204 3.66623 13.3445 4.01986 13.3445H12.0199C12.3735 13.3445 12.7126 13.204 12.9627 12.954C13.2127 12.7039 13.3532 12.3648 13.3532 12.0111V7.21115C13.3532 6.66248 13.0999 6.14448 12.6665 5.80782Z" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M10.6668 10C9.1935 10.8887 6.8055 10.8887 5.3335 10" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                </g>
                                <defs>
                            ...
                            <div className="flex p-6 justify-between flex-wrap md:flex-nowrap md:items-start gap-3">
                                ...
                                <p className="text-[#64717C] flex text-xs items-center gap-2 sm:text-base">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        <path d="M11.795 21H5C4.46957 21 3.96086 20.7893 3.58579 20.4142C3.21071 20.0391 3 19.5304 3 19V7C3 6.46957 3.21071 5.96086 3.58579 5.58579C3.96086 5.21071 4.46957 5 5 5H17C17.5304 5 18.0391 5.21071 18.4142 5.58579C18.7893 5.96086 19 6.46957 19 7V11H3M15 3V7M7 3V7M18 16.496V18L19 19M14 18C14 19.0609 14.4214 20.0783 15.1716 20.8284C15.9217 21.5786 16.9391 22 18 22C19.0609 22 20.0783 21.5786 20.8284 20.8284C21.5786 20.0783 22 19.0609 22 18C22 16.9391 21.5786 15.9217 20.8284 15.1716C20.0783 14.4214 19.0609 14 18 14C16.9391 14 15.9217 14.4214 15.1716 15.1716C14.4214 15.9217 14 16.9391 14 18Z" stroke="#64717C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                ...
                                <div className="flex flex-col gap-2 md:h-[114px] justify-between">
                                    ...
                                    <div className="text-xs text-[#0D9CD8] flex whitespace-nowrap" >
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                            <g clip-path="url(#clip0_682_16974)">
                                                <path d="M8 6H8.00667" stroke="#0D9CD8" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M7.3335 8H8.00016V10.6667H8.66683" stroke="#0D9CD8" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M8 2C12.8 2 14 3.2 14 8C14 12.8 12.8 14 8 14C3.2 14 2 12.8 2 8C2 3.2 3.2 2 8 2Z" stroke="#0D9CD8" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                            </g>
                                            <defs>
