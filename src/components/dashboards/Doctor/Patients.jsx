                ...
                <div className="pt-[24px] flex items-start gap-5">
                    ...
                    <div className="flex items-center text-[#64717C] text-sm h-[44px] px-[16px] bg-white rounded-lg">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                            <path d="M3.3335 3.33203H16.6668V5.14203C16.6667 5.58402 16.4911 6.00788 16.1785 6.32036L12.5002 9.9987V15.832L7.50016 17.4987V10.4154L3.76683 6.3087C3.48804 6.00197 3.33354 5.60236 3.3335 5.18786V3.33203Z" stroke="#64717C" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                    </div>
                </div>
