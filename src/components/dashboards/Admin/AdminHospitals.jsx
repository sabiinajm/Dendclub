...
function AdminHospitals() {
    return (
        <div className="bg-[#F2F5F8] min-h-screen px-[12px] md:px-[32px] py-10">
            ...
            <div className="grid justify-self-center gap-6 grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 xlll:grid-cols-4">
                <div className="bg-white rounded-[20px] w-full pb-[28px] flex flex-col items-center">
                    <div className=" relative  w-[257px] flex justify-center items-end rounded-[12px]">
                        <img src="/assets/images/klinika2.jpg" alt="doctor" className="w-full object-cover rounded-t-[20px] h-[184px]" />
                        <div className='bg-white rounded-[4px] font-normal text-sm gap-1 w-[66px] h-[24px] flex justify-center items-center top-[20px] left-[20px] absolute'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="19" viewBox="0 0 18 19" fill="none">
                                <path d="M9.41984 16.115C9.29743 16.2029 9.15053 16.2502 8.99984 16.2502C8.84914 16.2502 8.70224 16.2029 8.57984 16.115C4.95809 13.5335 1.11434 8.2235 5.00009 4.3865C6.06684 3.33714 7.50346 2.74934 8.99984 2.75C10.4998 2.75 11.9391 3.33875 12.9996 4.38575C16.8853 8.22275 13.0416 13.532 9.41984 16.115Z" stroke="#2C2C2E" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M9 9.5C9.39782 9.5 9.77936 9.34196 10.0607 9.06066C10.342 8.77936 10.5 8.39782 10.5 8C10.5 7.60218 10.342 7.22064 10.0607 6.93934C9.77936 6.65804 9.39782 6.5 9 6.5C8.60218 6.5 8.22064 6.65804 7.93934 6.93934C7.65804 7.22064 7.5 7.60218 7.5 8C7.5 8.39782 7.65804 8.77936 7.93934 9.06066C8.22064 9.34196 8.60218 9.5 9 9.5Z" stroke="#2C2C2E" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                            Bakı
                        </div>
                    </div>
                    <div className='flex flex-col pt-[11px]'>
                        <h1 className="text-xl">İstanbul NS Klinika</h1>
            ...
            <div>
                <img src="/assets/images/map1.jpg" alt="doctor" className="w-full rounded-xl mt-[40px] object-cover " />
            </div>
        </div>
    )
}
