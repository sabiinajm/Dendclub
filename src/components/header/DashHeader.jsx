...
function DashHeader() {
    return (
        <div className="min-h-[76px] max-w-[1168px]  flex items-center justify-between px-8">
            <div className="flex items-center gap-4">
                <HiBars3 className="text-2xl" />
                <div className="relative">
                    <input type="text" placeholder="Axtarın" className="pl-14 outline-none placeholder:text-[#64717C] border border-[#F2F5F8] rounded-[12px] h-[48px] w-full xl:min-w-[553px]" />
            ...
            <div className="flex items-center gap-5">
                ...
                <div className="flex gap-3 items-center">
                    <img src="/assets/images/ava.jpeg" className="h-[44px] w-[44px] object-[90%] object-cover rounded-full" alt="" />
